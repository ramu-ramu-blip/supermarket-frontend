            ...
            <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-6 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-black tracking-tighter text-slate-900 uppercase">SuperMarket<span className="text-primary">Pro</span></span>
                    </div>
            ...
            <header className="relative pt-40 pb-24 px-6">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-100 rounded-full mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">Trusted by 500+ Local Businesses</span>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
                        ...
                        {[
                            ...
                            <div key={i} className="relative z-10 bg-white p-10 rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/20 text-center group hover:-translate-y-2 transition-transform duration-500">
                                ...
                                <span className="text-5xl font-black text-slate-100 absolute top-6 right-10 group-hover:text-primary/10 transition-colors">{item.step}</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/5 rounded-full mb-6">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-primary">Powerful Dashboard</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 bg-white/5 backdrop-blur-lg border border-white/10 rounded-[40px] text-left group hover:bg-white/10 transition-all duration-500">
                                ...
                                <p className="text-slate-300 font-medium italic mb-8 leading-relaxed">"{testimonial.text}"</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center font-black text-primary uppercase">{testimonial.name[0]}</div>
                                    <div>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="border border-slate-100 rounded-[28px] overflow-hidden transition-all">
                                <button
                                    onClick={() => toggleFaq(i)}
                                ...
                                <div className={`px-8 overflow-hidden transition-all duration-300 ease-in-out ${activeFaq === i ? 'max-h-40 py-8 border-t border-slate-50' : 'max-h-0'}`}>
